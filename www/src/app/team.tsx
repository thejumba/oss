...
export function JumbaTeam({ deviceType }: { deviceType: string }) {
  return (
    <div className="mx-auto max-w-6xl py-16 px-10 border-t border-gray-900/70">
      ...
      <p className="px-0 md:px-4 text-xl text-gray-500 text-center">
            ...
            <div className="flex flex-col md:flex-row">
              ...
              <div className="w-full md:w-3/5 px-0 md:px-4" style={{}}>
                <div className="flex flex-col">
                  <p className="text-center text-gray-400 pt-8 md:pt-0">
                    {member.title}
                  </p>
                  <h2 className="text-3xl pt-3 text-center text-gray-200">
                    {member.name}
                  </h2>
